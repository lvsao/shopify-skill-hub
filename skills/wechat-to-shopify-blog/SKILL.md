...
**Step 5 — Verify** — the agent runs a quick check. If it didn't work, repeat Step 4.
...
9. **Verify**: `node C:\Users\qiuru\.agents\skills\wechat-to-shopify-blog\scripts\shopify-context.mjs --env skill-hub.env`
