...
Use the official sources below for the audit rules and API behavior. The specialist SEO sources are methodology context only; do not treat any source as a ranking guarantee.
