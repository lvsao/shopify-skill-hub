...
Create env file:
```
node <user-home>/.agents\skills\shopify-store-translator\scripts\shopify-translator-admin.mjs init-env --method admin_custom_app --env skill-hub.env
```
...
Connection check:
```
node <user-home>/.agents\skills\shopify-store-translator\scripts\shopify-translator-admin.mjs connection-check --env skill-hub.env
```
...
Create env file:
```
node <user-home>/.agents\skills\shopify-store-translator\scripts\shopify-translator-admin.mjs init-env --method dev_dashboard_app --env skill-hub.env
```
...
**Path A:**
```
node <user-home>/.agents\skills\shopify-store-translator\scripts\shopify-translator-admin.mjs check-locales --env skill-hub.env --target {locale}
```
...
**Path A:**
```
node <user-home>/.agents\skills\shopify-store-translator\scripts\shopify-translator-admin.mjs add-locale-to-market --env skill-hub.env --market-web-presence-id {id} --locale {locale}
```
