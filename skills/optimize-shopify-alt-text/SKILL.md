...
```text
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs init-env --method admin_custom_app --env skill-hub.env
```
...
```text
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs init-env --method dev_dashboard_app --env skill-hub.env
```
...
10. **Verify**: `node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs connection-check --env skill-hub.env`
...
```text
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --product "Hostinger Server"
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --product <product-handle-or-product-url>
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --collection <collection-handle-or-url>
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --article <article-gid-or-article-url-or-title>
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --media-id gid://shopify/MediaImage/...
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --url <cdn-image-url>
```

Add `--download --limit 3` when you need local files for visual inspection:

```text
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --product "Hostinger Server" --download --limit 3
```
...
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs init-env --method admin_custom_app --env skill-hub.env
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs init-env --method dev_dashboard_app --env skill-hub.env
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs connection-check --env skill-hub.env
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --product <product-title-or-handle-or-url>
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --product <product-title-or-handle-or-url> --download --limit 3
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --collection <collection-title-or-handle-or-url>
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --article <article-gid-or-url-or-title>
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --media-id gid://shopify/MediaImage/...
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs target --env skill-hub.env --url <cdn-image-url>
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs scan --env skill-hub.env --page-size 50
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs vision-sample --env skill-hub.env --limit 3
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs apply --env skill-hub.env --input -
node C:\Users\qiuru\.agents\skills\optimize-shopify-alt-text\scripts\shopify-alt-text-admin.mjs apply --env skill-hub.env --input - --execute
```
